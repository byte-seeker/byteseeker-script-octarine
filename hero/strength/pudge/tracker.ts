...
export const STABILITY_WINDOW = 0.3
...
export function calcCastPos(hero: Hero, target: Hero, hookRange: number): Vector3 {
...
export function timeToEnterRange(hero: Hero, target: Hero, hookRange: number): number | null {
