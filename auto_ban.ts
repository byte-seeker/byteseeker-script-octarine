...
new (class AutoBanUtility {
 ...
 private populateAndRefresh(): void {
  ...
  if (strengthHeroes.length > 0) {
   this.strengthSelector = this.strengthNode.AddImageSelector(
    "Strength Selectors",
    strengthHeroes,
   );
  ...
  if (agilityHeroes.length > 0) {
   this.agilitySelector = this.agilityNode.AddImageSelector(
    "Agility Selectors",
    agilityHeroes,
   );
  ...
  if (intellectHeroes.length > 0) {
   this.intellectSelector = this.intellectNode.AddImageSelector(
  ...
  if (universalHeroes.length > 0) {
   this.universalSelector = this.universalNode.AddImageSelector(
    "Universal Selectors",
    universalHeroes,
   );
